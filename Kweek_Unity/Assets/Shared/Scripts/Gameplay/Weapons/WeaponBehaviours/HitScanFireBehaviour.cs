...
namespace Kweek
{
    public class HitScanFireBehaviour : IWeaponUseBehaviour
    {
        ...
        [SerializeField]
        private float m_ImpactForce = 0.0f;

        [SerializeField]
        private AnimationCurve m_DamageFalloff = null;

        [SerializeField]
        private bool m_Piercing = false;
        ...
        [Space(5)]
        [SerializeField]
        private AnimationCurve m_RecoilPattern = null; //TODO: Create custom inspector because the curve editor can't handle multiple keyframes at the same time.

        [Tooltip("Adds randomisation in both directions")]
        [SerializeField]
        private AnimationCurve m_RecoilSpreadRate = null;

        [Tooltip("Time = number of bullets fired, Value = Time it takes to recoved entirely + Shoot Cooldown")]
        [SerializeField]
        private AnimationCurve m_RecoilCooldownRate = null;
        private float m_RecoilCooldownTimer = 0.0f;
        ...
        [Space(5)]
        [SerializeField]
        private int m_NumberOfProjectiles = 0;
        ...
        private List<Collider> m_IgnoredColliders = null;
