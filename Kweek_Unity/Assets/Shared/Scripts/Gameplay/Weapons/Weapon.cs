...
namespace Kweek
{
    public class Weapon : MonoBehaviour
    {
        ...
        [Space(5)]
        [SerializeField]
        private IWeaponUseBehaviour m_UseBehaviour = null;

        [SerializeField]
        private IWeaponUseBehaviour m_AltUseBehaviour = null;

        [SerializeField]
        private IAmmoUseBehaviour m_AmmoUseBehaviour = null;
        ...
        [Space(5)]
        [SerializeField]
        private WeaponPickup m_PickupPrefab = null;
        ...
        //Events
        public event WeaponUseDelegate WeaponUseEvent = null;
        public event WeaponStopUseDelegate WeaponStopUseEvent = null;
        public event UpdateAmmoDelegate UpdateAmmoEvent = null;

        public event SwitchWeaponCallback StartSwitchInEvent = null;
        public event SwitchWeaponCallback StopSwitchInEvent = null;
        public event SwitchWeaponCallback StartSwitchOutEvent = null;
        public event SwitchWeaponCallback StopSwitchOutEvent = null;
