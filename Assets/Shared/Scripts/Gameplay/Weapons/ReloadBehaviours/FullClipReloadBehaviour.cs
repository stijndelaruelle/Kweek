...
namespace Kweek
{
    public class FullClipReloadBehaviour : IAmmoUseBehaviour
    {
        ...
        [Space(5)]
        [SerializeField]
        protected int m_MaxAmmoInClip = 0;
        protected int m_AmmoInClip = 0;

        [SerializeField]
        protected AmmoTypeDefinition m_AmmoType = null;
        protected AmmoArsenal m_AmmoArsenal = null;
        ...
        [Space(5)]
        [SerializeField]
        protected AudioSource m_OutOfAmmoAudio = null; //Not an event as it's very specific to ammo dependant weapons
        ...
        protected void FireUpdateAmmoEvent()
        {
            ...
            FireUpdateAmmoEvent(m_AmmoInClip, reserveAmmo);
        }
