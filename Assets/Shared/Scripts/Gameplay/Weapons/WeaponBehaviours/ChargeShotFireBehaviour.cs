...
namespace Kweek
{
    public class ChargeShotFireBehaviour : IWeaponUseBehaviour
    {
        ...
        [SerializeField]
        private ChargeableProjectile m_ProjectilePrefab = null;
        private ChargeableProjectile m_CurrentProjectile = null;
        ...
        private Ray m_LastUsedRay = default(Ray); //To fire when fully charged
