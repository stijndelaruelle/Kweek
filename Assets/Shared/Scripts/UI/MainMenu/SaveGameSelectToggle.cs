...
namespace Kweek
{
    public class SaveGameSelectToggle : MonoBehaviour
    {
        ...
        [SerializeField]
        private Text m_DifficultyMode = null;

        [SerializeField]
        private DifficultyModeListDefinition m_DifficultyModes = null;

        [SerializeField]
        private Text m_SaveTime = null;

        [SerializeField]
        private Text m_PlayTime = null;
        ...
        private SaveGame m_SaveGame = null;
        public SaveGame SaveGame
        {
            get { return m_SaveGame; }
        }

        public event SaveGameSelectDelegate SaveGameSelectEvent = null;
