...
public class MovingPlatform : MonoBehaviour
{
    ...
    private List<IMoveableObject> m_MoveableObjects;
    ...
    private void Awake()
    {
        ...
        m_MoveableObjects = new List<IMoveableObject>();
    }
    ...
    {
        foreach (IMoveableObject passenger in m_MoveableObjects)
        {
    ...
    {
        IMoveableObject moveableObject = collision.gameObject.GetComponent<IMoveableObject>();
